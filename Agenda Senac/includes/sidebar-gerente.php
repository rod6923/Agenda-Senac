...
<aside class="sidebar">
    ...
    <nav class="sidebar-nav">
        <div class="nav-section">
            <p class="section-title">OPERAÇÕES</p>
            ...
            <a href="minhas-solicitacoes.php" class="nav-item <?php echo getNavClass('minhas-solicitacoes'); ?>">
                ...
                <span>Aprovação de Solicitações</span>
            </a>
        </div>
        <div class="nav-section">
            <p class="section-title">GERAL</p>
            <a href="colaboradores.php" class="nav-item <?php echo getNavClass('colaboradores'); ?>">
            ...
            <a href="relatorios.php" class="nav-item <?php echo getNavClass('relatorios'); ?>">
            ...
            <a href="notificacoes.php" class="nav-item <?php echo getNavClass('notificacoes'); ?>">
            ...
            <a href="configuracoes.php" class="nav-item <?php echo getNavClass('configuracoes'); ?>">
